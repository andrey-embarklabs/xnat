/*
 * core: org.nrg.xdat.turbine.modules.screens.XDATScreen_groups
...
public class XDATScreen_groups extends AdminScreen {
    ...
    protected void doBuildTemplate(PipelineData pipelineData, Context context)
        ...
        try {
            DisplaySearch search = UserHelper.getSearchHelperService().getSearchForUser(TurbineUtils.getUser(data),"xdat:userGroup","listing");
